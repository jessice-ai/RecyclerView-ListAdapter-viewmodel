 ...
 */
@Database(version = 2, entities = [SunUser::class])  //生命实体类（Entity）的名字 User 为跟数据库的版本号
...
//                ).allowMainThreadQueries().build()
                ...
                INSTANCE = Room.databaseBuilder(
                    ...
                    override fun migrate(database: SupportSQLiteDatabase) {
                        database.execSQL("ALTER TABLE sunuser ADD webformatHeight INTEGER Default 0 not null ")
                    }
