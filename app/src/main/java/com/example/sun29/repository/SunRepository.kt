package com.example.sun29.repository

import androidx.lifecycle.LiveData
import com.example.sun29.data.remote.Animal
import com.example.sun29.data.room.SunUser
import com.example.sun29.data.room.SunUserDao
            ...
            .responseObject(Animal.Deserializer()) { request, response, result ->
                ...
                if (animals != null) {
                    ...
                    for (cursor in animals.hits){
                        ...
                        insert(SunUser(i, cursor.largeImageURL,cursor.webformatHeight))
